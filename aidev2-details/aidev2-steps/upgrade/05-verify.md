...
- validate overall manifest shape against the local schema at `/home/parallels/.config/Code/User/prompts/aidev2-schemas/in-application/requirements-state-schema.json`
