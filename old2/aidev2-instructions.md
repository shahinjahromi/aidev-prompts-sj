...
```
aidev2-combined-details/preset-requirements/
  nfr-and-global-cr-by-core-stack/<stack>/nfr-and-global-cr-[implementation id].yaml
  tech_selections_by-core-stack/<stack>/technology-selection-[implementation_id].yaml
```
